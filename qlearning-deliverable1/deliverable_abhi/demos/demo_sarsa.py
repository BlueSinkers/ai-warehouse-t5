...
allow_diagonals = True  # set to True to enable diagonal movement
...
#finds the next position based on action
...
# sarsa algorithm picks starting and ending
start_pos = (0,0)
goal_pos = (2,4)

for episode in range(episodes):
    pos = start_pos
    action_idx = choose_action(pos)  # pick initial action
    for step in range(max_steps):
        ...
        next_action_idx = choose_action(new_pos)
        
        # sarsa update: use actual next action chosen
